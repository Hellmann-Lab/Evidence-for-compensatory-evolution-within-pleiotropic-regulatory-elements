...
stringent_set<-readRDS("../DA_ipsc_npc/RDS/jammPeaks_vs_ATACPeaks_NPC_stringent.rds") %>%
...
expr_pleio<- readRDS("../expression/summarized_expression_allTissues.rds") %>% 
  group_by(gene_id) %>% 
...
jamm_DNase_binary<-readRDS("../general/region_summary/jamm_region_info_full.rds") %>%
