...
```{r jamm}
jammR <- readRDS("../general/region_summary/jamm_region_info_full.rds")
...
saveRDS(tss, file="../distance_to_tss/gencode19.tssGR.rds")
```

## TSS-enhancer association 
Enhancers are only associated with TSS that have open promoters. This step does not need to be repeated as we save the outputs under distance_to_tss/DHS_to_gene.rds

```{r promenh2}

summarized_expression_all<-readRDS("../expression/summarized_expression_allTissues.rds")
tss<-readRDS("../distance_to_tss/gencode19.tssGR.rds")
...
saveRDS(DHS_to_gene, "../distance_to_tss/DHS_to_gene.rds")
...
srx_expression_info<-readRDS("../expression/srx_expression_info.rds")
