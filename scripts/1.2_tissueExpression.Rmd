...
saveRDS(srx_expression_info, "../expression/srx_expression_info.rds")
...
saveRDS(count_table, "../expression/expression_count_table.rds")
...
brain<- read.table("../expression/human_fetalbrain.allgenes.rpkm.csv", head=T, sep="\t") %>%
      dplyr::filter( E082 > 1 ) %>%
...
saveRDS(summarized_expression_all, "../expression/summarized_expression_allTissues.rds")
