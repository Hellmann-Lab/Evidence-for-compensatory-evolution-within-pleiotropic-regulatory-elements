...
out=per_NPC_DA_stringent


## declare an array variable
declare -a arr=("DA" "nonDA") 
...
sbatch -J INS"$n"_"$i" --error=$slurmpfx$i$n.err --output=$slurmpfx$i$n.out --chdir=$workdir --wrap="$workdir/scripts/INSIGHT_filtering.sh \
